...
import WorkoutAdmin from '/imports/ui/components/WorkoutAdmin';

/** Renders a table containing all of the Stuff documents. Use <StuffItem> to render each row. */
class ListWorkoutsAdmin extends React.Component {
  ...
  renderPage() {
    return (
        ...
        <Container>
          ...
          <Card.Group>
            {this.props.workouts.map((workout, index) => <WorkoutAdmin key={index} workout={workout} />)}
          </Card.Group>
        </Container>
        </div>
    );
